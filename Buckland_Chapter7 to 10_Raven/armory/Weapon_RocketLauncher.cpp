...
void RocketLauncher::InitializeFuzzyModule()
{
  ...
  FzSet& Target_Close = DistToTarget.AddLeftShoulderSet("Target_Close", 0, 50, 100);
  FzSet& Target_Close_Medium = DistToTarget.AddLeftShoulderSet("Target_Close_Medium", 50, 100, 150);
  FzSet& Target_Medium = DistToTarget.AddTriangularSet("Target_Medium", 100, 150, 200);
  FzSet& Target_Far_Medium = DistToTarget.AddLeftShoulderSet("Target_Far_Medium", 150, 200, 250);
  FzSet& Target_Far = DistToTarget.AddRightShoulderSet("Target_Far", 200, 250, 1000);
  ...
  FzSet& ALotDesirable = Desirability.AddTriangularSet("ALotDesirable", 50, 65, 85);
  FzSet& Desirable = Desirability.AddTriangularSet("Desirable", 35, 50, 65);
  FzSet& QuiteDesirable = Desirability.AddTriangularSet("QuiteDesirable", 15, 35, 50);
  FzSet& Undesirable = Desirability.AddLeftShoulderSet("Undesirable", 0, 15, 35);
  ...
  FzSet& Ammo_Great = AmmoStatus.AddTriangularSet("Ammo_Great", 6, 9, 12);
  FzSet& Ammo_Okay = AmmoStatus.AddTriangularSet("Ammo_Okay", 3, 6, 9);
  FzSet& Ammo_Low = AmmoStatus.AddTriangularSet("Ammo_Low", 0, 3, 6);
  ...
  m_FuzzyModule.AddRule(FzAND(Target_Close, Ammo_Loads), Undesirable);
  m_FuzzyModule.AddRule(FzAND(Target_Close, Ammo_Great), Undesirable);
  m_FuzzyModule.AddRule(FzAND(Target_Close, Ammo_Okay), Undesirable);
  m_FuzzyModule.AddRule(FzAND(Target_Close, Ammo_Low), Undesirable);
  m_FuzzyModule.AddRule(FzAND(Target_Close, Ammo_Empty), Undesirable);

  m_FuzzyModule.AddRule(FzAND(Target_Close_Medium, Ammo_Loads), Desirable);
  m_FuzzyModule.AddRule(FzAND(Target_Close_Medium, Ammo_Great), Desirable);
  m_FuzzyModule.AddRule(FzAND(Target_Close_Medium, Ammo_Okay), QuiteDesirable);
  m_FuzzyModule.AddRule(FzAND(Target_Close_Medium, Ammo_Low), Undesirable);
  m_FuzzyModule.AddRule(FzAND(Target_Close_Medium, Ammo_Empty), Undesirable);

  m_FuzzyModule.AddRule(FzAND(Target_Medium, Ammo_Loads), VeryDesirable);
  m_FuzzyModule.AddRule(FzAND(Target_Medium, Ammo_Great), VeryDesirable);
  m_FuzzyModule.AddRule(FzAND(Target_Medium, Ammo_Okay), ALotDesirable);
  m_FuzzyModule.AddRule(FzAND(Target_Medium, Ammo_Low), Desirable);
  m_FuzzyModule.AddRule(FzAND(Target_Medium, Ammo_Empty), Undesirable);

  m_FuzzyModule.AddRule(FzAND(Target_Far_Medium, Ammo_Loads), ALotDesirable);
  m_FuzzyModule.AddRule(FzAND(Target_Far_Medium, Ammo_Great), Desirable);
  m_FuzzyModule.AddRule(FzAND(Target_Far_Medium, Ammo_Okay), Desirable);
  m_FuzzyModule.AddRule(FzAND(Target_Far_Medium, Ammo_Low), QuiteDesirable);
  m_FuzzyModule.AddRule(FzAND(Target_Far_Medium, Ammo_Empty), Undesirable);

  m_FuzzyModule.AddRule(FzAND(Target_Far, Ammo_Loads), Desirable);
  m_FuzzyModule.AddRule(FzAND(Target_Far, Ammo_Great), QuiteDesirable);
  m_FuzzyModule.AddRule(FzAND(Target_Far, Ammo_Okay), QuiteDesirable);
  m_FuzzyModule.AddRule(FzAND(Target_Far, Ammo_Low), Undesirable);
