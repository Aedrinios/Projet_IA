; Listing generated by Microsoft (R) Optimizing Compiler Version 19.11.25547.0 
	...
	TITLE	C:\Users\corentin\Desktop\Licence Conception jeu vidéo\Projet_IA\Buckland_Chapter7 to 10_Raven\goals\Raven_Feature.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG177151 DB	'RailGun_MaxRoundsCarried', 00H
	ORG $+3
$SG177153 DB	'RocketLauncher_MaxRoundsCarried', 00H
$SG177155 DB	'ShotGun_MaxRoundsCarried', 00H
	ORG $+3
$SG177158 DB	'trying to calculate  of unknown weapon', 00H
CONST	ENDS
...
PUBLIC	??_C@_1KK@OOBCDDJO@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAc?$AAo?$AAr?$AAe?$AAn?$AAt?$AAi?$AAn?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAL?$AAi?$AAc?$AAe?$AAn?$AAc@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_1KK@OOBCDDJO@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAc?$AAo?$AAr?$AAe?$AAn?$AAt?$AAi?$AAn?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAL?$AAi?$AAc?$AAe?$AAn?$AAc@
CONST	SEGMENT
??_C@_1KK@OOBCDDJO@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAc?$AAo?$AAr?$AAe?$AAn?$AAt?$AAi?$AAn?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAL?$AAi?$AAc?$AAe?$AAn?$AAc@ DB 'C'
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\corentin\desktop\licence conception jeu vidéo\projet_ia\buckland_chapter7 to 10_raven\goals\raven_feature.cpp
_TEXT	SEGMENT
tv64 = -16						; size = 4
$T1 = -12						; size = 12
...
$LN5@Clamp:
	push	175					; 000000afH
	push	OFFSET ??_C@_1KK@OOBCDDJO@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAc?$AAo?$AAr?$AAe?$AAn?$AAt?$AAi?$AAn?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAL?$AAi?$AAc?$AAe?$AAn?$AAc@
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\corentin\desktop\licence conception jeu vidéo\projet_ia\buckland_chapter7 to 10_raven\armory\raven_weapon.h
...
; 212  :   Raven_WeaponSystem* const          GetWeaponSys()const{return m_pWeaponSys;}
