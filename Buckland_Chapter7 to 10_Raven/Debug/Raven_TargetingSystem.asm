; Listing generated by Microsoft (R) Optimizing Compiler Version 19.11.25547.0 
	...
	TITLE	C:\Users\corentin\Desktop\Licence Conception jeu vidéo\Projet_IA\Buckland_Chapter7 to 10_Raven\Raven_TargetingSystem.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?isInTeam@Raven_Bot@@QBE_NXZ			; Raven_Bot::isInTeam
PUBLIC	?isTeamTarget@Raven_Bot@@QBE_NXZ		; Raven_Bot::isTeamTarget
...
; 222  :   Raven_SensoryMemory* const         GetSensoryMem()const{return m_pSensoryMem;}
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\corentin\desktop\licence conception jeu vidéo\projet_ia\buckland_chapter7 to 10_raven\raven_bot.h
;	COMDAT ?isTeamTarget@Raven_Bot@@QBE_NXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?isTeamTarget@Raven_Bot@@QBE_NXZ PROC			; Raven_Bot::isTeamTarget, COMDAT
; _this$ = ecx

; 166  :   bool			isTeamTarget()const { return m_bIsTeamTarget; }
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	eax, DWORD PTR _this$[ebp]
	mov	al, BYTE PTR [eax+239]
	mov	esp, ebp
	pop	ebp
	ret	0
?isTeamTarget@Raven_Bot@@QBE_NXZ ENDP			; Raven_Bot::isTeamTarget
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\corentin\desktop\licence conception jeu vidéo\projet_ia\buckland_chapter7 to 10_raven\raven_bot.h
;	COMDAT ?isInTeam@Raven_Bot@@QBE_NXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?isInTeam@Raven_Bot@@QBE_NXZ PROC			; Raven_Bot::isInTeam, COMDAT
; _this$ = ecx

; 165  :   bool          isInTeam()const { return m_bInTeam; }
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	eax, DWORD PTR _this$[ebp]
	mov	al, BYTE PTR [eax+238]
	mov	esp, ebp
	pop	ebp
	ret	0
?isInTeam@Raven_Bot@@QBE_NXZ ENDP			; Raven_Bot::isInTeam
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\corentin\desktop\licence conception jeu vidéo\projet_ia\buckland_chapter7 to 10_raven\raven_bot.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\corentin\desktop\licence conception jeu vidéo\projet_ia\buckland_chapter7 to 10_raven\raven_targetingsystem.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
...
; 81   :   return m_pOwner->GetSensoryMem()->GetTimeOpponentHasBeenOutOfView(m_pCurrentTarget);
...
; 76   :   return m_pOwner->GetSensoryMem()->GetTimeOpponentHasBeenVisible(m_pCurrentTarget);
...
; 71   :   return m_pOwner->GetSensoryMem()->GetLastRecordedPositionOfOpponent(m_pCurrentTarget);
...
; 66   :   return m_pOwner->GetSensoryMem()->isOpponentShootable(m_pCurrentTarget);
...
; 61   :   return m_pOwner->GetSensoryMem()->isOpponentWithinFOV(m_pCurrentTarget);
...
; 32   : 		if ((*curBot)->isTeamTarget() && (*curBot)->isAlive() && (*curBot != m_pOwner) && m_pOwner->isInTeam())
	...
	mov	ecx, DWORD PTR [eax]
	call	?isTeamTarget@Raven_Bot@@QBE_NXZ	; Raven_Bot::isTeamTarget
	movzx	ecx, al
	test	ecx, ecx
	je	$LN5@Update
	lea	ecx, DWORD PTR _curBot$[ebp]
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax]
	call	?isInTeam@Raven_Bot@@QBE_NXZ		; Raven_Bot::isInTeam
	movzx	ecx, al
	test	ecx, ecx
	je	SHORT $LN5@Update
...
; 36   : 			if (dist < ClosestDistSoFar)
	...
	comisd	xmm0, QWORD PTR _dist$11[ebp]
	jbe	SHORT $LN7@Update

; 37   : 			{
; 38   : 				ClosestDistSoFar = dist;

	movsd	xmm0, QWORD PTR _dist$11[ebp]
	movsd	QWORD PTR _ClosestDistSoFar$[ebp], xmm0
...
; 43   : 		else if ( (*curBot)->isAlive() && (*curBot != m_pOwner) && !(m_pOwner->isInTeam()) )
...
; 44   : 		{
; 45   : 			double dist = Vec2DDistanceSq((*curBot)->Pos(), m_pOwner->Pos());
	...
	call	?Vec2DDistanceSq@@YANABUVector2D@@0@Z	; Vec2DDistanceSq
	add	esp, 8
	fstp	QWORD PTR _dist$10[ebp]

; 46   : 
; 47   : 			if (dist < ClosestDistSoFar)

	movsd	xmm0, QWORD PTR _ClosestDistSoFar$[ebp]
	comisd	xmm0, QWORD PTR _dist$10[ebp]
	jbe	SHORT $LN9@Update

; 48   : 			{
; 49   : 				ClosestDistSoFar = dist;

	movsd	xmm0, QWORD PTR _dist$10[ebp]
	movsd	QWORD PTR _ClosestDistSoFar$[ebp], xmm0

; 50   : 				m_pCurrentTarget = *curBot;
