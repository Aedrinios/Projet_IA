...
_BSS	ENDS
CONST	SEGMENT
$SG176648 DB	'Raven', 00H
$SG176727 DB	00H
?piecewise_construct@std@@3Upiecewise_construct_t@1@B	ORG $+1 ; std::piecewise_construct
$SG176650 DB	'MyWindowClass', 00H
	ORG $+2
$SG176724 DB	'map', 00H
$SG176725 DB	'Raven map file (*.map)', 00H
	ORG $+1
$SG176726 DB	'Filename: ', 00H
	ORG $+1
$SG176783 DB	'Error', 00H
	ORG $+2
$SG176784 DB	'Registration Failed!', 00H
	ORG $+3
$SG176787 DB	'Error!', 00H
	ORG $+1
$SG176788 DB	'CreateWindowEx Failed!', 00H
	ORG $+1
...
CONST	ENDS
_DATA	SEGMENT
?g_szApplicationName@@3PADA DD FLAT:$SG176648		; g_szApplicationName
?g_szWindowClassName@@3PADA DD FLAT:$SG176650		; g_szWindowClassName
_DATA	ENDS
...
EXTRN	?CreateTeam@Raven_Game@@QAEX_N@Z:PROC		; Raven_Game::CreateTeam
...
; 56   :     switch (msg)
	...
	movzx	eax, BYTE PTR $LN77@WindowProc[edx]
...
; 120  :         switch(wParam)
	...
	movzx	eax, BYTE PTR $LN78@WindowProc[edx]
	jmp	DWORD PTR $LN85@WindowProc[eax*4]
$LN10@WindowProc:
...
; 166  :          case VK_UP:
; 167  : 
; 168  :            g_pRaven->AddBots(1, UserOptions->m_bAgentHasTeam); break;
...
; 198  :      switch(wParam)
	...
	cmp	DWORD PTR tv214[ebp], 17		; 00000011H
	ja	$LN40@WindowProc
	mov	edx, DWORD PTR tv214[ebp]
	jmp	DWORD PTR $LN86@WindowProc[edx*4]
$LN22@WindowProc:
...
; 216  : 
; 217  :           g_pRaven->AddBots(1, UserOptions->m_bAgentHasTeam);
...
; 232  : 		
; 233  : 
; 234  : 	  case IDM_GAME_CREATE_TEAM:
; 235  : 
; 236  : 		  UserOptions->m_bAgentHasTeam = !UserOptions->m_bAgentHasTeam;
...
; 237  : 
; 238  : 		  CheckMenuItemAppropriately(hwnd, IDM_GAME_CREATE_TEAM, UserOptions->m_bAgentHasTeam);
...
; 239  : 
; 240  : 		  g_pRaven->CreateTeam(UserOptions->m_bAgentHasTeam);
	...
	push	eax
	mov	ecx, DWORD PTR ?g_pRaven@@3PAVRaven_Game@@A ; g_pRaven
	call	?CreateTeam@Raven_Game@@QAEX_N@Z	; Raven_Game::CreateTeam
...
; 337  :         UserOptions->m_bShowGoalsOfSelectedBot = !UserOptions->m_bShowGoalsOfSelectedBot;
	...
	test	edx, edx
	jne	SHORT $LN70@WindowProc
	mov	DWORD PTR tv433[ebp], 1
	jmp	SHORT $LN71@WindowProc
$LN70@WindowProc:
