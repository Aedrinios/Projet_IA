; Listing generated by Microsoft (R) Optimizing Compiler Version 19.11.25547.0 
	...
	TITLE	C:\Users\corentin\Desktop\Licence Conception jeu vidéo\Projet_IA\Buckland_Chapter7 to 10_Raven\goals\Raven_Goal_Types.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG36620 DB	'explore', 00H
$SG36622 DB	'think', 00H
	ORG $+2
$SG36624 DB	'arrive_at_position', 00H
	ORG $+1
$SG36626 DB	'seek_to_position', 00H
	ORG $+3
$SG36628 DB	'follow_path', 00H
$SG36630 DB	'traverse_edge', 00H
	ORG $+2
$SG36632 DB	'move_to_position', 00H
	ORG $+3
$SG36634 DB	'get_health', 00H
	ORG $+1
$SG36636 DB	'get_shotgun', 00H
$SG36638 DB	'get_railgun', 00H
$SG36640 DB	'get_rocket_launcher', 00H
$SG36642 DB	'wander', 00H
	ORG $+1
$SG36644 DB	'negotiate_door', 00H
	ORG $+1
$SG36646 DB	'attack_target', 00H
	ORG $+2
$SG36648 DB	'hunt_target', 00H
$SG36650 DB	'strafe', 00H
	ORG $+1
$SG36652 DB	'adjust_range', 00H
	ORG $+3
$SG36654 DB	'say_phrase', 00H
	ORG $+1
$SG36656 DB	'defense_strategy', 00H
	ORG $+3
$SG36658 DB	'UNKNOWN GOAL TYPE!', 00H
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\corentin\desktop\licence conception jeu vidéo\projet_ia\buckland_chapter7 to 10_raven\goals\raven_goal_types.cpp
_TEXT	SEGMENT
tv64 = -12						; size = 4
$T1 = -8						; size = 4
_this$ = -4						; size = 4
...
; 85   : 
; 86   :   case goal_defense_strategy:
; 87   : 
; 88   : 	  return "defense_strategy";
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\corentin\desktop\licence conception jeu vidéo\projet_ia\buckland_chapter7 to 10_raven\goals\raven_goal_types.h
