; Listing generated by Microsoft (R) Optimizing Compiler Version 19.11.25547.0 
	...
	TITLE	C:\Users\corentin\Desktop\Licence Conception jeu vidéo\Projet_IA\Buckland_Chapter7 to 10_Raven\armory\Projectile_Bolt.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG173314 DB	'Bolt_MaxForce', 00H
	ORG $+2
$SG173315 DB	'Bolt_Mass', 00H
	ORG $+2
$SG173316 DB	'Bolt_MaxSpeed', 00H
	ORG $+2
$SG173317 DB	'Bolt_Scale', 00H
	ORG $+1
$SG173318 DB	'Bolt_Damage', 00H
$SG173319 DB	'a', 00H, 'r', 00H, 'm', 00H, 'o', 00H, 'r', 00H, 'y', 00H
	DB	'\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'j', 00H, 'e', 00H, 'c'
	DB	00H, 't', 00H, 'i', 00H, 'l', 00H, 'e', 00H, '_', 00H, 'B', 00H
	DB	'o', 00H, 'l', 00H, 't', 00H, '.', 00H, 'c', 00H, 'p', 00H, 'p'
	DB	00H, 00H, 00H
	ORG $+2
$SG173320 DB	't', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'e', 00H, 't', 00H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\corentin\desktop\licence conception jeu vidéo\projet_ia\buckland_chapter7 to 10_raven\armory\projectile_bolt.cpp
_TEXT	SEGMENT
$T1 = -88						; size = 16
$T2 = -72						; size = 16
$T3 = -56						; size = 16
...
; 18   :         Raven_Projectile(target,
	...
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG173315
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG173316
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
