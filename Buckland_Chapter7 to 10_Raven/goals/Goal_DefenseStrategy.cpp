#include "Goal_DefenseStrategy.h"
#include "../Raven_Bot.h"
...
//------------------------------ ctor -----------------------------------------
//-----------------------------------------------------------------------------
Goal_DefenseStrategy::
Goal_DefenseStrategy(Raven_Bot*          pBot,
...
//------------------------------ Activate -------------------------------------
//-----------------------------------------------------------------------------
void Goal_DefenseStrategy::Activate()
{
	m_iStatus = active;
...
//-------------------------- Process ------------------------------------------
//-----------------------------------------------------------------------------
int Goal_DefenseStrategy::Process()
{
...
//---------------------------- Render -----------------------------------------
//-----------------------------------------------------------------------------
void Goal_DefenseStrategy::Render()
{
